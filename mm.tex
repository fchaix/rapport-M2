...
Parallèlement, un dénombrement par étalement sur géloses LBm de 100µl des dilutions XXX à XXX de la culture à la DO choisie a été effectué afin d’évaluer a posteriori le nombre de bactéries transformées. Pour les rendre compétentes à la transformation, les cellules ont ensuite subi un choc thermique de 15 min dans la glace puis centrifugées 10 min à 6000 rpm à 4°C. 
